...
Rule IDはREADMEで定義された `MD-<Scope>-<Category>-<Number>` 形式に従う。本Conventionで新規定義するRuleのScopeには`BS`を使用する。

---

## Document Structure（文書構造）

### MD-BS-DS-001: Document Title
...
### MD-BS-DS-002: Heading Hierarchy
...
### MD-BS-DS-004: Section Separation
...
### MD-BS-DS-007: No Emphasis as Heading
...
### MD-BS-CO-006: Blank Lines Around Lists
...
### MD-BS-CR-001: Fenced Code Blocks
...
### MD-BS-CR-002: Language Identifier
...
### MD-BS-PS-001: Blank Lines Between Sections
...
### MD-BS-PS-002: No Trailing Spaces
...
| --- | --- |
| MD-BS-DS-002 | markdownlint (MD001) |
| MD-BS-DS-003 | markdownlint (MD025) |
| MD-BS-DS-005 | markdownlint (MD022) |
| MD-BS-DS-006 | markdownlint (MD024) |
| MD-BS-DS-007 | markdownlint (MD036) |
| MD-BS-CO-006 | markdownlint (MD032) |
| MD-BS-CR-002 | markdownlint (MD040) |
| MD-BS-PS-002 | markdownlint (MD009) |
