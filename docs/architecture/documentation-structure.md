...
4. Logical Structure（論理構造）と、Directory / File等の
   Physical Structure（物理構造）は、どのような境界を持つのか。
...
- Documentation Asset（文書資産）の内部構造・記述形式・
...
### 7. Minimal Model First（最小Modelから始める）
